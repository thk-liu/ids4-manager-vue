...
import { del } from '@/api/administration/api-resources'
import edit from './api-resources-edit'
...
export default {
  data() {
    return {
      ...
      loadData: parameter => {
        return identity.api_resources(Object.assign(this.query, parameter))
      },
      model: {},
  ...
  methods: {
    ...
    del(id, index) {
      ...
      this.$confirm({
        ...
        onOk() {
          del(id).then(data => {
            scope.$message.success('API资源删除成功')
